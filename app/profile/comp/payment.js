      ...
      <View>
        ...
        <View
          ...
          <View style={{width: 110, marginLeft: 20}}>
            <Dropdown label="Expiry yyyy" data={data} />
          </View>

          <View style={{width: 110, marginRight: 20}}>
            <Dropdown label="Expiry mm" data={month} />
          </View>
        </View>
      </View>
    );
  ...
  render() {
    return (
      <View style={{margin: 20, width: 250, alignSelf: 'center'}}>
        <Dropdown label="Select your bank" data={banks} />
      </View>
    );
  }
}
      ...
      <View>
        <View style={{flexDirection: 'row', margin: 20}}>
          <Icon
            ...
            color="#000"
          />
          <Text style={{marginLeft: 30, position: 'absolute', fontSize: 20}}>
            Paytm wallet
          </Text>
        </View>
      </View>
    ...
    return (
      <View>
        <View style={{height: 80}}>
          <Text style={{margin: 20, fontSize: 21}}>Rs.</Text>
        </View>
        <ScrollView>
